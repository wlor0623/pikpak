<template>
  <div class="list-page list-page-files" v-contextmenu:contextmenu>
    ...
    <n-modal v-model:show="showAddUrl">
      <n-card style="width: 600px;" title="添加链接或文件夹">
    ...
    <v-contextmenu ref="contextmenu">
      <v-contextmenu-item @click="getFileList">刷新页面</v-contextmenu-item>
      <!-- <v-contextmenu-item @click="getFileList">刷新页面</v-contextmenu-item> -->
    </v-contextmenu>
...
const smallColums = ref<DataTableColumns>([
  {
    ...
    align: "right",
    render: (row) => {
      return dayjs(row.modified_time).format("MM/DD HH:mm");
      // return h(NTime, {
      //   // time: new Date(String(row.modified_time) || ""),
      //   // format: "MM-dd HH:MM",
      //   to: new Date(String(row.modified_time) || ""),
      //   type: "relative",
      // });
    },
...
// https://api-drive.mypikpak.com/drive/v1/files  post
let wlor = {
  body: { duration: "420", width: "640", height: "400" },
  kind: "drive#file",
  name: "ad-pc.txt",
  size: "2524870",
...
// https://vip-lixian-06.mypikpak.com/upload_tmp/D83BD291D3AFCC60D76FA7736B8D341BFB5ADBFE_1637574398643700563 put
// 19位 时间戳+6位随机数
// uploadId=72909D0D179D4523B1A335EEA92F0743
// partNumber=6
const addUrl = () => {
